  ...
  return (
    <section className="px-8 py-4">
      ...
      <div className="flex justify-between items-center mb-10">
        <h2 className="text-3xl font-semibold">License Free</h2>
          ...
          {products.map((p) => (
            ...
            >
              ...
              <div className="text-sm mb-3">
                <span className="line-through text-gray-400 mr-2">{p.old}</span>
